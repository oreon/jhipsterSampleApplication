...
class InvoiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoice entity")
        ...
        .repeat(2) {
            ...
            .post("/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "date":"2020-01-01T00:00:00.000Z", "details":"SAMPLE_TEXT", "status":null, "paymentMethod":null, "paymentDate":"2020-01-01T00:00:00.000Z", "paymentAmount":"0"}""")).asJSON
            .check(status.is(201))
