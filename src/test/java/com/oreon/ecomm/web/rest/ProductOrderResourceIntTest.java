...
import static com.oreon.ecomm.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.oreon.ecomm.domain.enumeration.OrderStatus;
/**
...
public class ProductOrderResourceIntTest {
    ...
    public void initTest() {
        productOrderSearchRepository.deleteAll();
    ...
    public void createProductOrder() throws Exception {
        ...
        ProductOrder productOrderEs = productOrderSearchRepository.findOne(testProductOrder.getId());
        assertThat(productOrderEs).isEqualToIgnoringGivenFields(testProductOrder);
    }
    ...
    public void deleteProductOrder() throws Exception {
        ...
        boolean productOrderExistsInEs = productOrderSearchRepository.exists(productOrder.getId());
        assertThat(productOrderExistsInEs).isFalse();
