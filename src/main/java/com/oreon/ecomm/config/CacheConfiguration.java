package com.oreon.ecomm.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.oreon.ecomm.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.oreon.ecomm.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
